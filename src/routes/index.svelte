  ...
  <div class="mx-0 sm:mx-6">
    ...
    >
      ...
      <div class="flex flex-wrap justify-between pt-12 -mx-6">
        {#each posts as post}
          <Post col="1/3" {post} {base} />
        {/each}
        {#each posts as post}
          <Post col="2/3" {post} {base} />
          <Post col="1/3" {post} {base} />
        {/each}
      </div>
    </div>
    ...
    >
      ...
      >
        Get the latest music posts notified right to your inbox
      </h3>
    ...
    <div class="flex w-full items-center font-sans p-8 md:p-24">
      ...
      <div class="flex-1">
        ...
        <p class="text-gray-600 text-xs md:text-base">
          This awesome site was created by my friend <a
            class="text-gray-800 hover:text-green-500 no-underline border-b-2 border-green-500"
            href="https://www.tailwindtoolbox.com">Logan Bennett</a
          >
        </p>
      </div>
  ...
  <div class="container max-w-6xl mx-auto flex items-center px-2 py-8">
    <div class="w-full mx-auto flex flex-wrap items-center">
      ...
      >
        ...
        >
          <li>
            <a class="inline-block py-2 px-3 text-white no-underline" href="#"
              >Active</a
            >
          </li>
          <li>
