<script>
	...
	export let data;
	const { artistData, songData } = data;

	let songs = songData.tracks;
	console.log(songs);
...
<div class="flex flex-col text-3xl mt-4 items-center justify-center">
	<h1>Brooke falls - {artistData.followers.total} followers</h1>
