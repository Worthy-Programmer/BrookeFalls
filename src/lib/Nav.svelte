    ...
    <a href="{base}/"><h3 class="text-xl text-blue-900">HOME 🏠</h3></a>
      ...
      <a class="flex items-center h-10 p-2 md:h-auto md:p-4" href="/about">
        <h2>About</h2>
       	...
       	<a class="flex items-center inline-block text-gray-500 no-underline hover:text-white hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 avatar" data-tippy-content="@twitter_handle" href="https://twitter.com/intent/tweet?url=#">
				...
				<a class="flex items-center inline-block text-gray-500 no-underline hover:text-white hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 avatar" data-tippy-content="#facebook_id" href="https://www.facebook.com/sharer/sharer.php?u=#">
